        ...
        if (info.function) {
            ...
            if (info.function == "getMyGroups") {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    var badgeUsername = "<span class='badge badge-danger'>" + info.convGroup[i] + "</span>"
                    htmlInner += '<li class="m-menu__item m-menu__item--active" aria-haspopup="true"><a href="#' + info.listGroup[i] + '" class="m-menu__link userLi"><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-title"> <span class="m-menu__link-wrap"> <span class="m-menu__link-text">  ' + info.listGroup[i] + '</span> ' + (info.convGroup[i] > 0 ? badgeUsername : "") + ' </span></span></a></li>';
            ...
            if (info.function == "receiveMessage") {
                ...
                if (info.senderID == client) {
                    ...
                    $(".chatArea").append('<div class="m-widget3"> <div class="m-widget3__item"> <div class="m-widget3__header"> <div class="m-widget3__user-img">  </div> <div class="m-widget3__info"> <span class="m-widget3__username"> @' + info.fromUname + ' </span><br> <span class="m-widget3__time"> a few seconds ago </span> </div> <span class="m-widget3__status m--font-info"> Delivered </span> </div> <div class="m-widget3__body"> <p class="m-widget3__text"> ' + info.message + ' </p> </div> </div> </div><hr />');
